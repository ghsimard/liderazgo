...
const hubs: HubSpec[] = [
  ...
  { id: "admin-fichas", title: "Admin — Fichas", type: "Hub admin", routes: ["/admin"], role: "Admin con permiso fichas", features: [{ feature: "Lista de fichas", description: "Tabla con fichas RLT, filtrable por región/entidad." }, { feature: "Edición de ficha", description: "Editar cualquier campo." }, { feature: "Exportación Excel", description: "Descarga masiva." }, { feature: "Descarga PDF", description: "PDF individual." }], mindmap: `mindmap\n  root((Admin Fichas))\n    Lista\n      Filtros region\n      Busqueda\n    Acciones\n      Editar ficha\n      Descargar PDF\n      Exportar Excel` },

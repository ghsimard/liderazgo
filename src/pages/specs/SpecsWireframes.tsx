...
const sections: WireframeSection[] = [
  ...
  {
    title: "2. Mi Panel — Directivo",
    screens: [
      { label: "Mi Panel — Vista Rector", src: "/images/mi-panel-directivo-preview.png" },
    ],
  },
  {
    title: "3. Mi Panel — Evaluador",
    screens: [
  ...
  {
    title: "4. Admin — Enlaces",
    screens: [
      { label: "Formularios y Rúbrica", src: "/images/specs/admin-enlaces-preview.png" },
    ],
  },
  {
    title: "5. Admin — Fichas",
    screens: [
  ...
  {
    title: "8. Admin — Informe de Módulo",
    screens: [
  ...
  {
    title: "9. Admin — Ambiente Escolar",
    screens: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:px-8">
        ...
        <p className="text-muted-foreground mb-8">
          Captures d'écran de toutes les vues de l'application, organisées par section. Le filtre visuel « croquis » est appliqué pour distinguer la documentation de l'interface réelle.
        </p>

        <p className="text-sm text-muted-foreground mb-6">
          {sections.reduce((sum, s) => sum + s.screens.length, 0)} écrans au total
        </p>

...
-- ============================================================
-- Vue : instituciones par cohorte
-- Source unique = fichas_rlt (jointe par region = ae_cohortes.nombre).
-- ae_cohorte_instituciones conservée en base pour historique mais
-- n'alimente plus cette vue.
-- ============================================================

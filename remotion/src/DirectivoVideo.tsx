...
const STEPS = [
  { file: "images/dir-step1-panel.png", label: "1. Mi Panel — Directivo", desc: "Vista del panel del rector con sus opciones" },
  { file: "images/dir-step2-ficha.png", label: "2. Ficha de Información Básica", desc: "Datos personales, institucionales y académicos" },
  { file: "images/dir-step3-rubrica.png", label: "3. Rúbrica de Evaluación", desc: "Evaluación por módulos con niveles de desempeño" },
  { file: "images/dir-step4-encuestas-hub.png", label: "4. Encuestas 360° — Hub", desc: "Autoevaluación y envío a evaluadores externos" },
  { file: "images/dir-step5-autoevaluacion.png", label: "5. Autoevaluación 360°", desc: "Instrumento de autopercepción de competencias" },
];
...
export const DirectivoVideo: React.FC = () => {
  return (
    <AbsoluteFill>
